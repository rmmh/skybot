...
class TestCrowdcontrol(TestCase):
    ...
    def test_no_matches(self):
        mocks = self.call_crowd_control("Hello world!", rules=[{"re": "No match"}])

        for m in mocks.values():
            m.assert_not_called()

    def test_match_no_action(self):
        mocks = self.call_crowd_control("Hello world!", rules=[{"re": "Hello"}])
    ...
    def test_match_only_msg(self):
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "msg": "Hello!"}]
        )
    ...
    def test_match_ban_forever_no_kick(self):
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "ban_length": -1}]
        )
    ...
    def test_match_kick_no_ban(self):
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "kick": 1}]
        )
    ...
    def test_match_kick_with_msg(self):
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "kick": 1, "msg": "Hello!"}]
        )
    ...
    def test_match_kick_ban_forever(self):
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "kick": 1, "ban_length": -1}]
        )
    ...
    def test_match_ban_only_time_limit(self, mock_time_sleep):
        ...
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "ban_length": 5}]
        )
    ...
    def test_match_kick_ban_time_limit(self, mock_time_sleep):
        ...
        mocks = self.call_crowd_control(
            "Hello world!", rules=[{"re": "Hello", "kick": 1, "ban_length": 5}]
        )
